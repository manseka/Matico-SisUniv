    ...
    <div class="col-md-8">
        <div class="card card-outline card-primary">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ url('admin/materias/create') }}" class="btn btn-primary btn-sm ml-auto">
                        ...
                        @foreach ($materias as $materia)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('admin/materias/' . $materia->id . '/edit') }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmarEliminacion({{ $materia->id }})">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                    <form id="form-eliminar-{{ $materia->id }}" action="{{ url('admin/materias/' . $materia->id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
