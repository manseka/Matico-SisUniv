...
@section('title', 'Carreras Academicas')

@section('content_header')
    <h1>Listado de Carreras Academicas</h1>
    <br>
@stop
    ...
    <div class="col-md-8">
        <div class="card card-outline card-primary">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title mb-0">Carreras Registradas</h3>
                <a href="{{ url('admin/carreras/create') }}" class="btn btn-primary btn-sm ml-auto">
                        ...
                        @foreach ($carreras as $carrera)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('admin/carreras/' . $carrera->id . '/edit') }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmarEliminacion({{ $carrera->id }})">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                    <form id="form-eliminar-{{ $carrera->id }}" action="{{ url('admin/carreras/' . $carrera->id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
