...
@section('title', 'Gestiones Academicas')
    ...
    <div class="col-md-8">
        <div class="card card-outline card-primary">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title mb-0">Gestiones Registradas</h3>
                <a href="{{ url('admin/gestiones/create') }}" class="btn btn-primary btn-sm ml-auto">
                    <i class="fas fa-plus"></i> Nueva Gestion
                </a>
            </div>
                        ...
                        @foreach ($gestiones as $gestion)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('admin/gestiones/' . $gestion->id . '/edit') }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmarEliminacion({{ $gestion->id }})">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                    <form id="form-eliminar-{{ $gestion->id }}" action="{{ url('admin/gestiones/' . $gestion->id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
