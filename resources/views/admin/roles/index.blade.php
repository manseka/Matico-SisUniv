    ...
    <div class="col-md-8"> <!-- INICIO columna central -->
        <div class="card card-outline card-primary"> <!-- INICIO card -->
            ...
            <div class="card-header d-flex justify-content-between align-items-center"> <!-- INICIO card header -->
                ...
                <a href="{{ url('admin/roles/create') }}" class="btn btn-primary btn-sm ml-auto">
                        ...
                        @foreach ($roles as $rol)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('admin/roles/' . $rol->id . '/edit') }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmarEliminacion({{ $rol->id }})">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                    <form id="form-eliminar-{{ $rol->id }}" action="{{ url('admin/roles/' . $rol->id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
