    ...
    <div class="col-md-8">
        <div class="card card-outline card-primary">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ url('admin/niveles/create') }}" class="btn btn-primary btn-sm ml-auto">
                        ...
                        @foreach ($niveles as $nivel)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('admin/niveles/' . $nivel->id . '/edit') }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmarEliminacion({{ $nivel->id }})">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                    <form id="form-eliminar-{{ $nivel->id }}" action="{{ url('admin/niveles/' . $nivel->id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
