    ...
    <div class="col-md-8">
        <div class="card card-outline card-primary">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ url('admin/turnos/create') }}" class="btn btn-primary btn-sm ml-auto">
                        ...
                        @foreach ($turnos as $turno)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('admin/turnos/' . $turno->id . '/edit') }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmarEliminacion({{ $turno->id }})">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                    <form id="form-eliminar-{{ $turno->id }}" action="{{ url('admin/turnos/' . $turno->id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
